export default function EssayWriterPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white px-4">
      <h1 className="text-5xl md:text-6xl font-bold text-center mb-6">AI Essay Writer</h1>
      <p className="text-lg text-center text-lime-900 mb-8 max-w-2xl">
        Effortlessly generate high-quality essays and academic content with FliqAI's advanced AI-powered writing tools.
      </p>
      <a
        href="#"
