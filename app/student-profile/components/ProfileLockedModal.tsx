...
export const ProfileLockedModal: React.FC<ProfileLockedModalProps> = ({ 
  onUnlock, 
  isUnlocking,
  userCredits = 0 
}) => {
  const router = useRouter();
  const hasEnoughCredits = userCredits >= 15;
    ...
    <div className="flex items-center justify-center py-8">
      ...
      >
        ...
        <p className="text-sm text-gray-600 dark:text-dark-text text-center mb-4">
          This is a premium profile, but fret not, you have<br />enough credits to unlock it
        </p>
        ...
        <div className="bg-white dark:bg-dark-tertiary border-2 border-black p-4 mb-4" style={{ boxShadow: '2px 2px 0 0 #000' }}>
          <div className="flex items-center justify-center gap-2 mb-1">
            ...
            <span className="text-3xl font-bold text-black dark:text-dark-text">15</span>
          </div>
        ...
        <div className="space-y-2">
          {!hasEnoughCredits && (
            <div className="bg-red-50 border-2 border-red-500 p-3 text-center mb-2" style={{ boxShadow: '2px 2px 0 0 #dc2626' }}>
              ...
              <p className="text-xs text-red-600 mt-1">
                You have {userCredits} credits but need 15
              </p>
            </div>
          )}
          ...
          >
            {isUnlocking ? 'Unlocking...' : hasEnoughCredits ? 'Unlock Profile' : 'Buy More Credits'}
          </button>
