    ...
    <div className="bg-white border-2 border-black p-6 mt-14 mx-auto max-w-6xl w-full" style={{ boxShadow: '4px 4px 0 0 #000' }}>
      <div className="flex flex-col md:flex-row items-center ">
        <div className="md:w-3/5 space-y-4 py-2 px-9">
          <h3 className="text-2xl font-bold text-black leading-tight ">Worried about your weak test <br/>scores?We think this could help.</h3>
          ...
          <Link 
            href=""
            target="_blank"
            className="inline-block bg-[#FF9169] text-black  py-2 px-2 font-medium border-2 border-black hover:bg-black hover:text-[#FF9169] transition-colors"
